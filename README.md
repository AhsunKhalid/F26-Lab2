...
In this lab you will create eleven simple scripts. Write the scripts in GitHub Codespaces. 
Please note that you must start working on the lab during the class hours and show your progress to the professor to receive the marks for the lab.
...
## Lab 2 Sign-Off
- Craet a  PDF file containing all the  screenshots of each individual script, the screenshot must show your scripts and command line interface and output.
- The screenshot must also show your username on github codespaces.
- Submit your PDF file which shows your code, explanation and output for all the questions. The PDF file should be named as PRG101_Lab2_YoourFirstname_yourLastname on blackboard. If the screenshots do not correctly show the information mentioned above, you will get zero marks for the lab.
    - lab2a.py
    - lab2b.py
    - lab2c.py
    - lab2d.py
